                    ...
                    <div class="card-body p-md-5 mx-md-4">
                        ...
                        <form>
                            ...
                            @php
                                ...
                                $variable = 'variable';
                            @endphp
                            <x-inputfield type="text" placeholder="Enter your Name" name="Name" :number="$variable" />
                            {{-- other method --}}
                            {{-- <x-inputfield type="text" placeholder="Enter your Name" name="{{$variable}}"  /> --}}

                            <x-inputfield type="text" placeholder="Enter your Username" name="Username" />

                            <x-inputfield type="email" placeholder="Enter your email" name="Email Address" />

                            <x-inputfield type="password" placeholder="Enter your Password" name="Password" />

                            <x-inputfield type="password" placeholder="Enter your confirm Password" name="confirm Password" />
